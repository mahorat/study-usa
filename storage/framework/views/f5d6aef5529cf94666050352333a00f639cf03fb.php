...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.theme.min.css">
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('css/docs.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('css/bootstrap-social.css')); ?>">
    <link href="<?php echo e(URL::to('css/nav.css')); ?>" rel="stylesheet">
...
<div class="container-fluid">
            <nav class="navbar navbar-default navbar-fixed-top pos-menu" id="transparent">
                    ...
                    <a href="<?php echo e(Route('welcome')); ?>"><img src="<?php echo e(URL::to('img/i-junior-wh.png')); ?>" class="navbar-brand hidden-mb" style="height:75px !important; margin-top:-20px;"></a>
                     <a href="<?php echo e(Route('welcome')); ?>"><img src="<?php echo e(URL::to('img/i-junior.png')); ?>" class="navbar-brand hidden-cm" style="    height: 65px !important; margin-top: -9px; position: absolute;"></a>   
                    </div>
...
<div class="btn-group lang" role="group">
    <button id="droplang" type="button" class="btn btn-drop dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
     <img src="<?php echo e(URL::to('img/usa.png')); ?>" style="margin-right: 4px;" alt="USA"><i class="caret"></i>
    </button>
    <ul class="dropdown-menu" aria-labelledby="droplang">
        <li> <a class="dropdown-item" href="#"><img src="<?php echo e(URL::to('img/rus.png')); ?>" alt="RUS"></a></li>
        <li> <a class="dropdown-item" href="#"><img src="<?php echo e(URL::to('img/esp.png')); ?>" alt="ESP"></a></li>
    </ul>
...
<br>
            ...
            <div class="container">
                <div class="col-lg-4 col-md-4 col-ms-4 col-xs-12 text-left center-xs">
                    <ul class="footer_list">
                        <a href="<?php echo e(Route('welcome')); ?>"><img src="<?php echo e(URL::to('img/i-junior.png')); ?>" width="180" alt=""></a>
                    </ul>
                </div>
    ...
    <script src="<?php echo e(URL::to('js/slider.js')); ?>"></script>
    <script src="<?php echo e(URL::to('js/docs.js')); ?>"></script>
...
<?php echo $__env->make('includes.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script src="<?php echo e(URL::to('js/paralaxbg.js')); ?>"></script>
    <script>
