...
<section class="three" style="margin-top:50px;">
    ...
    <div class="row profile-info">
        <div class="col-md-8">
            <h4><?php echo e($data->name); ?> <?php echo e($data->surname); ?> <?php echo e($data->middlename); ?></h4>
            <p><?php echo e($id_stud); ?></p>
        </div>
        <div class="col-md-4 text-right" style="margin-top: 25px;">
          
            <a href="<?php echo e(Route('profile-edit')); ?>" class="btn btn-primary"><span class="fa fa-pencil"></span> Edit</a>
        ...
        <div class="col-md-3 col-sm-12 col-xs-12" style="margin-top: -20px;">
            <section id="profile-sidebar">
                    ...
                    <section class="box-container">
                               ...
                               <div class=" col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class=" col-md-3 col-sm-3 col-xs-12">
                                   <span class="edit-section">
                                       <a href="<?php echo e(Route('profile-edit')); ?>" class="btn btn-primary pull-right"><span class="fa fa-pencil"></span> Edit</a>
                                   </span>
                               </div>
                           </div>
                        ...
                        <div class="box-container-body">
                            <div class="row profile-body text-center">
                                ...
                                ?>
                                    <?php if($photo != null): ?>
                                        <img src="<?php echo e(URL::to('storage/app/documents/'.$path)); ?>" class="img-thumbnail" alt="">
                                    <?php else: ?>
                                        <img src="<?php echo e(URL::to('img/male-default.jpg')); ?>" class="img-thumbnail" alt="">
                                    <?php endif; ?>
                ...
                <div class="profile-usermenu">
                    <ul class="nav">
                        <li class="<?php echo e(!empty($overview) ? 'active' : ''); ?>">
                            <a href="<?php echo e(Route('profile-info')); ?>">
                            <i class="glyphicon glyphicon-home"></i>
                            Overview </a>
                        </li>
                        <li class="<?php echo e(!empty($zayavka) ? 'active' : ''); ?>">
                            <a href="<?php echo e(Route('application_info')); ?>">
	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			...
			<form action="<?php echo e(Route('ajaxImageUpload')); ?>" enctype="multipart/form-data" method="POST">
