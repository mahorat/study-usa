...
<link href="<?php echo e(URL::to('css/welcome.css')); ?>" rel="stylesheet">
<section id="slider">
        <div id="mycarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item">
                    <img src="<?php echo e(URL::to('img/slider-home1.jpg')); ?>" data-color="lightblue" alt="First Image">
                    <div class="carousel-caption">
                        <h3>First Image</h3>
                    </div>
                </div>
                <div class="item">
                    <img src="<?php echo e(URL::to('img/slider-home2.jpg')); ?>" data-color="firebrick" alt="Second Image">
                    <div class="carousel-caption">
                        <h3>Second Image</h3>
                    </div>
                </div>
                <div class="item">
                    <img src="<?php echo e(URL::to('img/slider-home3.jpg')); ?>" data-color="violet" alt="Third Image">
                    <div class="carousel-caption">
                        <h3>Third Image</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <select name="level" id="search_input" class="form-control">
                        ...
                        <?php $__currentLoopData = $level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level->id); ?>"><?php echo e($level->degreeLevel); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
...
<section id="cards">
    <div class="container-fluid">
        ...
        <div class="cards">
            <a href="#">
                <span class="img">
            <img src="<?php echo e(URL::to('img/1_1.jpg')); ?>" alt="">
        ...
        <div class="cards">
            <a href="#">
                <span class="img">
            <img src="<?php echo e(URL::to('img/2_2.jpg')); ?>" alt="">
        ...
        <div class="cards">
            <a href="#">
                <span class="img">
            <img src="<?php echo e(URL::to('img/3_3.jpg')); ?>" alt="">
        ...
        <div class="cards">
            <a href="#">
                 <span class="img">
            <img src="<?php echo e(URL::to('img/4_1.jpg')); ?>" alt="">
...
<!--<div class="servicefot">
   ...
   <!-- <div class="container content-container main-container " style="margin-top:125px; padding-top:40px">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <img src="<?php echo e(URL::to('img/abt-back.png')); ?>" class="img-thumbnail" alt=""><br><br>
...
<section class="testimonials">
        <div class="container-fluid">
            <div class="demo">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us0.png')); ?>" alt="">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us1.png')); ?>" alt="">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us2.png')); ?>" alt="">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us3.png')); ?>" alt="">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us4.png')); ?>" alt="">
                ...
                <span class="img">
            <img src="<?php echo e(URL::to('img/us5.png')); ?>" alt="">
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        ...
                        <br>
                        <div class="col-md-4 col-xs-12 text-center" style="padding-top:10px;"><img src="<?php echo e(URL::to('img/marker-1.png')); ?>" alt=""></div>
                        <div class="col-md-4 col-xs-12 text-center" style="padding-top:10px;"><img src="<?php echo e(URL::to('img/marker-2.png')); ?>" alt=""></div>
                        <div class="col-md-4 col-xs-12 text-center" style="padding-top:10px;"><img src="<?php echo e(URL::to('img/marker-3.png')); ?>" alt=""></div>
                        </div>
                        </div>
                        </div>
                    <div class="col-md-6 col-xs-12"><img src="<?php echo e(URL::to('img/young-man.png')); ?>" alt="" style="clear:both;" class="img img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
