		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="red" id="wizard">
		                    <form action="<?php echo e(Route('student_data_save')); ?>" method="post">
		                                	...
		                                	<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('surname') ? 'has-error' : ''); ?>">
														  ...
														  <input name="surname" type="text" class="form-control" value="<?php echo e(old('surname')); ?>">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating">
														  ...
														  <input name="middlename" type="text" class="form-control" value="<?php echo e(old('middlename')); ?>">
												...
												<div class="input-group">
													...
													<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 row">
														<div class="form-group label-floating <?php echo e($errors->has('day') ? 'has-error' : ''); ?>">
															...
															<input name="day" type="number" max="31" min="1" class="form-control" value="<?php echo e(old('day')); ?>">
													...
													<div class=" col-md-4 col-lg-4 col-sm-4 col-xs-12">
														<div class="form-group label-floating <?php echo e($errors->has('month') ? 'has-error' : ''); ?>">
															...
															<input name="month" type="number" max="12" min="1" class="form-control" value="<?php echo e(old('month')); ?>">
													...
													<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
														<div class="form-group label-floating <?php echo e($errors->has('year') ? 'has-error' : ''); ?>">
															...
															<input name="year" type="number" class="form-control" value="<?php echo e(old('year')); ?>">
												...
												<div class="input-group">
													...
													<div class="input-group">
														...
														<div class="form-group label-floating <?php echo e($errors->has('postal_code') ? 'has-error' : ''); ?>">
															...
															<input name="postal_code" type="text" class="form-control" value="<?php echo e(old('postal_code')); ?>">
													...
													<div class="input-group">
														...
														<div class="form-group label-floating <?php echo e($errors->has('region') ? 'has-error' : ''); ?>">
															...
															<input name="region" type="text" class="form-control" value="<?php echo e(old('region')); ?>">
													...
													<div class="input-group">
														...
														<div class="form-group label-floating <?php echo e($errors->has('city') ? 'has-error' : ''); ?>">
																...
																<input name="city" type="text" class="form-control" value="<?php echo e(old('city')); ?>">
													...
													<div class="input-group">
														...
														<div class="form-group label-floating <?php echo e($errors->has('phone_number') ? 'has-error' : ''); ?>">
															...
															<input name="phone_number" type="text" class="form-control" value="<?php echo e(old('phone_number')); ?>">
		                                    ...
		                                    <div class="col-sm-8">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('name_of_the_school') ? 'has-error' : ''); ?>">
			                                          	...
			                                          	<input name="name_of_the_school" type="text" class="form-control" value="<?php echo e(old('name_of_the_school')); ?>">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('school_city') ? 'has-error' : ''); ?>">
															<label class="control-label">City</label>
															<input name="school_city" type="text" class="form-control" value="<?php echo e(old('school_city')); ?>">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('school_street') ? 'has-error' : ''); ?>">
														...
														<input name="school_street" type="text" class="form-control" value="<?php echo e(old('school_street')); ?>">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('year_of_starting') ? 'has-error' : ''); ?>">
														...
														<input name="year_of_starting" type="number" class="form-control" value="<?php echo e(old('year_of_starting')); ?>">
												...
												<div class="input-group">
													...
													<div class="form-group label-floating <?php echo e($errors->has('year_of_ending') ? 'has-error' : ''); ?>">
														...
														<input name="year_of_ending" type="number" class="form-control" value="<?php echo e(old('year_of_ending')); ?>">
