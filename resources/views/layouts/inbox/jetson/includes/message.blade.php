															...
															<div class="heading-inbox">
																<div class="container-fluid">
																	...
																	<div class="pull-right text-right">
																		...
																		<button class="btn btn-sm mr-10" title=""><a href="{{route('trash').'/'.encrypt($id)}}"><i class="zmdi zmdi-delete"></i></a></button>
																...
																<div class="container-fluid mb-20">	
																	<h4 class="weight-500">{{$subject}}</h4>
																</div>	
															</div>
															<div class="sender-info">
																<div class="container-fluid">
																	...
																	<div class="sender-details   pull-left">
																		<span class="capitalize-font pr-5 txt-dark block font-15 weight-500 head-font">{{$sender}}</span>
																		<span class="block">
																			to <span class="capitalize-font pr-5 txt-dark block font-15 weight-500 head-font">
																					{{($user_id == $sender_id) ? "$recipient" : "me"}}
																			</span>
																		</span>	
																	</div>	
																	<div class="pull-right">
																		<div class="inline-block mr-5">
																			<span class="inbox-detail-time-1 font-12">{{\App\Helpers\Helpers::dateDiff($date)}}</span>
