                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav pull-nav">
                            ...
                            <li class="dropdown text-justify"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true"
                                    aria-expanded="false"><img src="{{URL::to('img/usa.png')}}" alt="" class="img img-responsive lang pull-left">
                                    </a>
                                <ul class="dropdown-menu langd">
                                    <li><a href="#"><img src="{{URL::to('img/esp.png')}}" alt="" class="img img-responsive lang pull-left"></a></li>
                                    <li><a href="#"><img src="{{URL::to('img/rus.png')}}" alt="" class="img img-responsive lang pull-left"></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
...
<form id="msform" action="{{Route('candidate_save')}}" enctype="multipart/form-data" method="post" novalidate>
        {{csrf_field()}}
    ...
    @endforeach
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="form-inline">
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('name_of_the_school') ? 'has-error' : '' }}">
                                <label for="s_u">School/University name<span class="starrr"> *</span></label>
                                <input type="text" id="s_u" class="form-control" name="name_of_the_school" placeholder="School name" value="{{$student_data->name_of_the_school}}">
                                <span class="text-danger">{{ $errors->first('name_of_the_school') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('school_street') ? 'has-error' : '' }}">
                                <label for="school">School's address<span class="starrr"> *</span></label>
                                <input type="text" id="school" class="form-control" name="school_street" placeholder="Address line" value="{{$student_data->school_street}}">
                                <span class="text-danger">{{ $errors->first('school_street') }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('city') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="City" name="city" value="{{$student_data->city}}">
                                <span class="text-danger">{{ $errors->first('city') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('school_region') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="State / Province / Region" name="school_region" value="{{$student_data->region}}">
                                <span class="text-danger">{{ $errors->first('school_region') }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('school_zip') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="Postal / Zip Code" name="school_zip" value="{{ old('school_zip') }}">
                                <span class="text-danger">{{ $errors->first('school_zip') }}</span>
                            </div>
                            <div class="col-md-6">
                                <?php $place_of_birth = $student_data->school_location; ?>
                                <select class="form-control">
                                @foreach($country as $countr)
                                    @if($countr->id == $place_of_birth)
                                        <option value="{{$countr->id}}" selected>{{$countr->country_name}}</option>
                                    @else
                        ...
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('school_phone') ? 'has-error' : '' }}">
                                <label for="phone">Phone<span class="starrr"> *</span></label>
                                <input type="text" id="phone" class="form-control" name="school_phone" value="{{ old('school_phone') }}" required>
                                <span class="text-danger">{{ $errors->first('school_phone') }}</span>
                            </div>
                           
                            <div class="col-md-6">
                                <label for="contact">Other contact</label>
                                <input type="text" id="contact" class="form-control" name="other_contact" value="{{ old('other_contact') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('year_of_starting') ? 'has-error' : '' }}">
                                <label for="year">What year are you in<span class="starrr"> *</span></label>
                                <input id="year" class="form-control" type="text" name="year_of_starting" value="{{$student_data->year_of_starting}}">
                                <span class="text-danger">{{ $errors->first('year_of_starting') }}</span>
                            </div>
                           
                            <div class="col-md-6 {{ $errors->has('year_of_ending') ? 'has-error' : '' }}">
                                <label for="stud">What are you stading<span class="starrr"> *</span></label>
                                <input id="stud" class="form-control" type="number" name="year_of_ending" value="{{$student_data->year_of_ending}}">
                                <span class="text-danger">{{ $errors->first('year_of_ending') }}</span>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('level_of_english') ? 'has-error' : '' }}">
                                <label for="lavel">Lavel of English<span class="starrr"> *</span></label>
                                <input id="lavel" class="form-control" type="text" name="level_of_english" value="{{ $student_data->level_of_english }}">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="form-inline">
                        <div class="row">
                            <div class="col-md-4 {{ $errors->has('sponsor_name') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" id="exampleInputName1" name="sponsor_name" placeholder="First" value="{{ old('sponsor_name') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_name') }}</span>
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder="Middle" name="sponsor_middlename" value="{{ old('sponsor_middlename') }}">
                            </div>
                            <div class="col-md-4 {{ $errors->has('sponsor_lastname') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="Last" name="sponsor_lastname" value="{{ old('sponsor_lastname') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_lastname') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-inline">
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('sponsor_email') ? 'has-error' : '' }}">
                                <label for="mail">Sponsor Email<span class="starrr"> *</span></label>
                                <input type="email" class="form-control" name="sponsor_email" id="mail" value="{{ old('sponsor_email') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_email') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('sponsor_phone') ? 'has-error' : '' }}">
                                <label for="phone">Phone<span class="starrr"> *</span></label>
                                <input type="email" class="form-control" name="sponsor_phone" id="phone" value="{{ old('sponsor_phone') }}">
                    ...
                    <div class="form-inline">
                        <div class="row">
                            ...
                            <div class="col-md-6 {{ $errors->has('sponsor_address') ? 'has-error' : '' }}" >
                                <input type="text" class="form-control" placeholder="Street Address" name="sponsor_address" value="{{ old('sponsor_address') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_address') }}</span>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Address line 2" name="sponsor_address2" value="{{ old('sponsor_address2') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('sponsor_city') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="City" name="sponsor_city" value="{{ old('sponsor_city') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_city') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('sponsor_region') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="State / Province / Region" name="sponsor_region" value="{{ old('sponsor_region') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_region') }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('sponsor_zip') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="Postal / Zip Code" name="sponsor_zip" value="{{ old('sponsor_zip') }}">
                                <span class="text-danger">{{ $errors->first('sponsor_zip') }}</span>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-inline">
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('father_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" id="parent" placeholder="Please write your parent's occupation" name="father_name" value="{{ old('father_name') }}">
                            ...
                            <div class="col-md-6 {{ $errors->has('father_occupation') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" id="parent" placeholder="Please write your parent's occupation" name="father_occupation" value="{{ old('father_occupation') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('mother_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" id="parent" placeholder="Please write your parent's occupation" name="mother_name" value="{{ old('mother_name') }}">
                                <span class="text-danger">{{ $errors->first('mother_name') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('mather_occupation') ? 'has-error' : '' }}">
                                <label for="parent">Occupation<span class="starrr"> *</span></label>
                                <input class="form-control" id="parent" placeholder="Please write your parent's occupation" name="mather_occupation" value="{{ old('mather_occupation') }}">
                                <span class="text-danger">{{ $errors->first('mather_occupation') }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('parent_address') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="Street Address" name="parent_address" value="{{ old('parent_address') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('parent_city') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="City" name="parent_city" value="{{ old('parent_city') }}">
                                <span class="text-danger">{{ $errors->first('parent_city') }}</span>
                            </div>
                            <div class="col-md-6 {{ $errors->has('parent_region') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="State / Province / Region" name="parent_region" value="{{ old('parent_region') }}">
                                <span class="text-danger">{{ $errors->first('parent_region') }}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 {{ $errors->has('parent_zip') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" placeholder="Postal / Zip Code" name="parent_zip" value="{{ old('parent_zip') }}">
                                <span class="text-danger">{{ $errors->first('parent_zip') }}</span>
                            </div>
                            <div class="col-md-6">
...
<script src="{{URL::to('js/fileUpload.js')}}"></script>
<script src="{{URL::to('js/fileUploader.js')}}"></script>
