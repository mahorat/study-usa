		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container">
		                <div class="card wizard-card" data-color="red" id="wizard">
		                    <form action="{{ Route('addUniverInfo') }}" method="POST" enctype="multipart/form-data">
		                            	...
		                            	<div class="row">
		                                	...
		                                	<div class="col-sm-6">
												<div class="input-group">
													...
													<div class="form-group label-floating {{ $errors->has('university_name') ? 'has-error' : '' }}">
														...
														<input name="university_name" type="text" value="{{ old('university_name') }}" class="form-control" required>
												...
												<div class="input-group">
													...
													<div class="form-group label-floating {{ $errors->has('abbreviated') ? 'has-error' : '' }}">
														  ...
														  <input name="abbreviated" type="text" value="{{ old('abbreviated') }}" class="form-control" required>
		                                	...
		                                	<div class="col-sm-6">
		                                    	<div class="form-group label-floating {{ $errors->has('short_description') ? 'has-error' : '' }}">
													...
													<textarea class="form-control" name="short_description"  placeholder="" rows="5" required>{{ old('short_description') }}</textarea>
		                                ...
		                                <div class="row">
		                                	...
		                                	<div class="col-sm-6">
		                                    	<div class="form-group label-floating {{ $errors->has('street') ? 'has-error' : '' }}">
													...
													<input name="street" type="text" class="form-control" value="{{ old('street') }}" required>
												...
												<div class="form-group label-floating {{ $errors->has('university_website') ? 'has-error' : '' }}">
													...
													<input name="university_website" type="text" class="form-control" value="{{ old('university_website') }}" required>
		                                ...
		                                <div class="row">
		                                    <div class="col-sm-6">
												<div class="input-group">
													...
													<div class="form-group label-floating {{ $errors->has('emp_fullname') ? 'has-error' : '' }}">
														  ...
														  <input name="emp_fullname" type="text" class="form-control" value="{{ old('emp_fullname') }}" required>
												...
												<div class="input-group">
													...
													<div class="form-group label-floating {{ $errors->has('emp_position') ? 'has-error' : '' }}">
														  ...
														  <input name="emp_position" type="text" class="form-control" value="{{ old('emp_position') }}" required>
		                                	...
		                                	<div class="col-sm-6">
												...
												<div class="form-group label-floating {{ $errors->has('emp_email') ? 'has-error' : '' }}">
													...
													<input name="emp_email" type="text" class="form-control" value="{{ old('emp_email') }}" required>
												...
												<div class="form-group label-floating {{ $errors->has('emp_phone') ? 'has-error' : '' }}">
													...
													<input name="emp_phone" type="text" class="form-control" value="{{ old('emp_phone') }}" required>
